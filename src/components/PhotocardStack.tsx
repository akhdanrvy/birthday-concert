...
const PHOTOCARDS: PhotocardItem[] = [
  {
    ...
    title: 'Rockstar Aca',
    caption: 'Aksi panggung kece nan memukau!',
  ...
  },
  {
    ...
    fallbackSrc: './images/images (2).jpeg',
    title: 'Happy Milad Aca',
    caption: 'Momen tiup lilin dan kue kesayangan!',
  ...
  },
  {
    ...
    fallbackSrc: './images/images (3).jpeg',
    title: 'Pembalap Handal',
    caption: 'Ngebut seru di arena gokart!',
  ...
  },
  {
    ...
    fallbackSrc: './images/images (4).jpeg',
    title: 'Temanan Merpati',
    caption: 'Senyum manis bareng sahabat burung!',
  ...
  },
  {
    ...
    fallbackSrc: './images/images (5).jpeg',
    title: 'Siap Komandan',
    caption: 'Pose hormat gemas penuh semangat!',
